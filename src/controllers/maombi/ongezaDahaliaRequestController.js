...
ongezaDahaliaRequestController.get(
  ...
  function (req, res) {
    ...
    sendRequest(req, res, badiliDahalia, "POST", formData, (jsonData) => {
      ...
      res.render(path.join(__dirname + "//../views/maombi/dahalia"), {
        req: req,
  ...
  function (req, res) {
    ...
    sendRequest(
      ...
      (jsonData) => {
        ...
        console.log(
          new Date() + " " + req.session.userName + ": /BadiliDahalia"
        );
        res.render(
          path.join(
            __dirname + "//../views/maombi/details/view-badili-dahalia"
          ),
          {
            req: req,
            ...
            Maoni: Maoni,
            commentUrl: "/KuongezaDahaliaComment",
            commentRedirectUrl: "/KuongezaDahalia",
          }
        );
      }
    );
...
ongezaDahaliaRequestController.post(
  "/KuongezaDahaliaComment",
  isAuthenticated,
  can("create-comments"),
  function (req, res) {
