// Load the map
   ...
   initilizeMap();
    ...
    const setMapStatus = (text, type = "secondary") => {
      $("#map-status")
        .removeClass("bg-soft-secondary bg-soft-success bg-soft-warning bg-soft-danger text-secondary text-success text-warning text-danger")
        .addClass(`bg-soft-${type} text-${type}`)
        .text(text);
    };
                ...
                ajaxRequest(
                  ...
                  (response) => {
                    ...
                    if (statusCode == 300) {
                      ...
                      setMapStatus(`Imeonyesha shule ${data.length}`, "success");
                      data.forEach((item) => {
                        const {
                          latitude,
                          longitude,
                      ...
                      setMapStatus("Imeshindikana kupakia data ya ramani", "danger");
                    }
                  },
