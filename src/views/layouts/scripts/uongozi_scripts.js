...
function BadiliData(e) {
  ...
  var unitName = e.getAttribute("data-unit-name") || "";
  ...
  document.getElementById("unit-name2-field").value = unitName;
...
function sajiliHati() {
  ...
  var unitName = document.getElementById("unit-name-field").value;
...
function sasishaHati() {
  ...
  var unitName = document.getElementById("unit-name2-field").value;
