...
function modal(modalId, show = false) {
  ...
  var myModal = bootstrap.Modal.getOrCreateInstance
    ? bootstrap.Modal.getOrCreateInstance(element, config)
