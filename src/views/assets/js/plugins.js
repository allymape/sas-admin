...
//   document.querySelectorAll("[data-provider]")) &&
//   (document.writeln(
//     "<script type='text/javascript' src='/design/assets/libs/tostify/tostify-js.js'></script>"
//   ),
//   document.writeln(
//     "<script type='text/javascript' src='/design/assets/libs/choices.js/choices.min.js'></script>"
//   ),
//   document.writeln(
//     "<script type='text/javascript' src='/design/assets/libs/flatpickr/flatpickr.min.js'></script>"
//   ));
...
(document.querySelectorAll("[toast-list]") ||
  ...
  // ),
  document.writeln(
    "<script type='text/javascript' src='..//../views/assets/js/choices/choices.min.js'></script>"
  ),
  document.writeln(
