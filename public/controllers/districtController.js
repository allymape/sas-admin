...
districtController.get("/HalmashauriList", isAuthenticated, can('view-districts'), function (req, res) {
...
districtController.post("/VutaWilaya", isAuthenticated, can('create-districts'), function (req, res) {
