...
const { sendRequestTest,  generateLetter, bodyContent, formatDate } = require("../../../util");
const API_BASE_URL = process.env.API_BASE_URL;
const baruaDetailsAPI = API_BASE_URL + "barua";


maombiBaruaController.get("/barua_test/:tracking_number",
  function (req, res) {
    ...
    sendRequestTest(req, res, baruaDetailsAPI + "/" + tracking_number, 'POST', formData, (jsonData) => {
