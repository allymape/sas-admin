...
anzishaShuleRequestController.get("/TaarifaOmbi/:id", function (req, res) {
      
        sendRequest(req, res, ombiDetails , 'POST' , {} , (jsonData) => {
                // const {message , statusCode , data} = jsonData
      ...
      function (error, response, body) {
        ...
        if (body !== undefined) {
          ...
          if (statusCode == 300) {
            ...
            res.render(
              path.join(
                __dirname + "/public/design/maombi/details/view-ombi-details"
              ),
              {
                req: req,
                muda_ombi: remain_days,
